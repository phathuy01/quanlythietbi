    ...
    <div class="bg-white shadow-sm z-20 sticky top-0">
        <div class="container mx-auto px-4 py-4">
            ...
            <div class="flex justify-between items-center mb-4">
                <h1 class="text-2xl font-bold text-gray-800">Quản lý vị trí</h1>
                <div class="flex space-x-4">
                    <button onclick="document.getElementById('addModal').classList.remove('hidden')" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg flex items-center">
                        <i class="bi bi-plus-circle mr-2"></i> Thêm vị trí
                    </button>
                    ...
                    <a href="{{ route('vitri.download') }}" class="bg-indigo-500 hover:bg-indigo-600 text-white px-4 py-2 rounded-lg flex items-center">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $viTri->ten_vt }}</td>
                            <td class="px-6 py-4 text-sm text-gray-900">{{ $viTri->mota }}</td>
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <button onclick="openEditModal('{{ $viTri->id_vt }}', '{{ $viTri->ten_vt }}', '{{ $viTri->mota }}')"
                                    class="text-blue-600 hover:text-blue-900 mr-3"
                                    data-tooltip="Sửa vị trí">
                                    <i class="bi bi-pencil"></i>
                                </button>
                                <button onclick="openDeleteModal('{{ $viTri->id_vt }}')"
                                    class="text-red-600 hover:text-red-900"
                                    data-tooltip="Xóa vị trí">
...
@include('QuanLyDonVi.ViTri.partials.modals')
@section('script')
<script>
